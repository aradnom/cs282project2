...
int main(int argc, char **argv) {
  ...
  objState->setVelocity(simphys::vec3{0.0, 0.001f, 0});
  objState->setAcceleration(simphys::vec3{0, 0.00f, 0.0f});
  objState->setAngVelocity(simphys::vec3{0.000f, 0.000f, 0.001f});
  objState->setAngAcceleration(simphys::vec3{0.0, 0.000, 0.000});
